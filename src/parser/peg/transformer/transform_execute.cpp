...
unique_ptr<SQLStatement> PEGTransformerFactory::TransformExecuteStatement(PEGTransformer &transformer, std::string_view identifier, vector<FunctionArgument> table_function_arguments) {
