...
static bool PGQMatchesVertexReference(const shared_ptr<PropertyGraphTable> &vertex_table,
...
PEGTransformerFactory::TransformPropertyGraphAllColumnsExcept(PEGTransformer &transformer, const bool &has_result,
...
PropertyGraphProperties
PEGTransformerFactory::TransformPropertyGraphPropertyList(PEGTransformer &transformer,
...
PropertyGraphLabel
PEGTransformerFactory::TransformPropertyGraphExplicitLabel(PEGTransformer &transformer, const Identifier &col_id,
...
PropertyGraphLabel
PEGTransformerFactory::TransformPropertyGraphImplicitLabel(PEGTransformer &transformer,
...
PEGTransformerFactory::TransformSourceTableReference(PEGTransformer &transformer,
...
PropertyGraphTableReference
PEGTransformerFactory::TransformDestinationTableReference(PEGTransformer &transformer,
                                                          unique_ptr<BaseTableRef> base_table_name) {
	PropertyGraphTableReference result;
	result.table = std::move(base_table_name);
	return result;
	...
	if (graph_table_columns_clause) {
		...
		for (auto &path_pattern : graph_path_pattern_list) {
			for (auto &path_reference : path_pattern->path_elements) {
				...
				match_expression->column_list.push_back(
				    make_uniq<StarExpression>(Identifier(path_element->variable_binding)));
			}
		}
	}
	for (auto &path_pattern : graph_path_pattern_list) {
...
PEGTransformerFactory::TransformGraphTableColumnsClause(PEGTransformer &transformer,
...
unique_ptr<PathPattern> PEGTransformerFactory::TransformGraphPathPattern(PEGTransformer &transformer,
...
vector<unique_ptr<PathPattern>>
PEGTransformerFactory::TransformGraphPathPatternList(PEGTransformer &transformer,
                                                     vector<unique_ptr<PathPattern>> graph_path_pattern) {
	return graph_path_pattern;
}

Identifier PEGTransformerFactory::TransformGraphPathVariable(PEGTransformer &transformer,
                                                             const Identifier &identifier) {
	return identifier;
}
...
vector<unique_ptr<PathReference>>
PEGTransformerFactory::TransformGraphEdgeVertexPattern(PEGTransformer &transformer,
...
string PEGTransformerFactory::TransformGraphRangeQuantifier(PEGTransformer &transformer,
