...
BindResult ExpressionBinder::BindExpression(FunctionExpression &function, idx_t depth,
	...
	// PG-compat (port of v2026.05.18 TransformAExprInternal hack): for the
	// specific functions PG returns a set for, prefer the TABLE_FUNCTION_ENTRY
	// over the SCALAR_FUNCTION_ENTRY when called in a SELECT list. Other
	// scalar/table dual-name functions like `repeat` keep their scalar
	// semantics.
