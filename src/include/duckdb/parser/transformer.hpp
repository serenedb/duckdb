...
private:
	...
	//! Transform a Postgres duckdb_libpgquery::T_PGCreatePublicationStmt node into a PragmaStatement
	unique_ptr<SQLStatement> TransformCreatePublication(duckdb_libpgquery::PGCreatePublicationStmt &stmt);
