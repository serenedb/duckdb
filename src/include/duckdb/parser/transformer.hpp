...
private:
	...
	//! DeleteStatement(s) carrying is_truncate=true. Multi-table TRUNCATE
	//! produces one DeleteStatement per relation wrapped in a MultiStatement;
	//! single-table returns just the DeleteStatement directly.
