...
private:
	...
	static unique_ptr<TransformResultValue> TransformAlterIndexStmtInternal(PEGTransformer &transformer,
	                                                                        ParseResult &parse_result);
	static unique_ptr<AlterInfo> TransformAlterIndexStmt(PEGTransformer &transformer, const bool &if_exists,
	...
	static unique_ptr<TransformResultValue> TransformAlterFunctionStmtInternal(PEGTransformer &transformer,
	                                                                           ParseResult &parse_result);
	static unique_ptr<AlterInfo> TransformAlterFunctionStmt(PEGTransformer &transformer, const bool &if_exists,
	...
	static unique_ptr<TransformResultValue> TransformDropConstraintInternal(PEGTransformer &transformer,
	                                                                        ParseResult &parse_result);
	static unique_ptr<AlterTableInfo> TransformDropConstraint(PEGTransformer &transformer, const bool &if_exists,
	                                                          std::string_view identifier, const bool &drop_behavior);
	...
	TransformRenameConstraint(PEGTransformer &transformer, std::string_view identifier, std::string_view identifier_1);
	...
	static unique_ptr<TransformResultValue> TransformIdentifierDotInternal(PEGTransformer &transformer,
	                                                                       ParseResult &parse_result);
	static string TransformIdentifierDot(PEGTransformer &transformer, std::string_view identifier);
	...
	static unique_ptr<AlterInfo> TransformAlterDatabaseStmt(PEGTransformer &transformer, const bool &if_exists,
	                                                        std::string_view identifier, std::string_view identifier_1);
	...
	static unique_ptr<TransformResultValue> TransformDropDatabaseStatementInternal(PEGTransformer &transformer,
	                                                                               ParseResult &parse_result);
	static unique_ptr<SQLStatement> TransformDropDatabaseStatement(PEGTransformer &transformer, const bool &if_exists,
	                                                               std::string_view catalog_name,
	...
	static unique_ptr<TransformResultValue> TransformSecretStorageSpecifierInternal(PEGTransformer &transformer,
	                                                                                ParseResult &parse_result);
	static string TransformSecretStorageSpecifier(PEGTransformer &transformer, std::string_view identifier);
	...
	static unique_ptr<TransformResultValue> TransformTriggerNameInternal(PEGTransformer &transformer,
	                                                                     ParseResult &parse_result);
	static string TransformTriggerName(PEGTransformer &transformer, std::string_view identifier);
	...
	static unique_ptr<TransformResultValue> TransformExecuteStatementInternal(PEGTransformer &transformer,
	                                                                          ParseResult &parse_result);
	static unique_ptr<SQLStatement>
	TransformExecuteStatement(PEGTransformer &transformer, std::string_view identifier,
	                          vector<unique_ptr<ParsedExpression>> table_function_arguments);
	...
	static unique_ptr<TransformResultValue> TransformExtensionAliasInternal(PEGTransformer &transformer,
	                                                                        ParseResult &parse_result);
	static string TransformExtensionAlias(PEGTransformer &transformer, std::string_view identifier);
	...
	static unique_ptr<TransformResultValue> TransformPragmaAssignInternal(PEGTransformer &transformer,
	                                                                      ParseResult &parse_result);
	static unique_ptr<SQLStatement> TransformPragmaAssign(PEGTransformer &transformer, std::string_view setting_name,
	...
	static unique_ptr<TransformResultValue> TransformPragmaFunctionInternal(PEGTransformer &transformer,
	                                                                        ParseResult &parse_result);
	static unique_ptr<SQLStatement> TransformPragmaFunction(PEGTransformer &transformer, std::string_view pragma_name,
	...
	static unique_ptr<TransformResultValue> TransformPrepareStatementInternal(PEGTransformer &transformer,
	                                                                          ParseResult &parse_result);
	static unique_ptr<SQLStatement> TransformPrepareStatement(PEGTransformer &transformer, std::string_view identifier,
	...
	static unique_ptr<TransformResultValue> TransformUpdateSetColumnTargetInternal(PEGTransformer &transformer,
	                                                                               ParseResult &parse_result);
	static string TransformUpdateSetColumnTarget(PEGTransformer &transformer, std::string_view column_name,
	...
	static unique_ptr<TransformResultValue> TransformUseTargetCatalogSchemaInternal(PEGTransformer &transformer,
	                                                                                ParseResult &parse_result);
	static QualifiedName TransformUseTargetCatalogSchema(PEGTransformer &transformer, std::string_view catalog_name,
	...
	static unique_ptr<TransformResultValue> TransformDotIdentifierInternal(PEGTransformer &transformer,
	                                                                       ParseResult &parse_result);
	static string TransformDotIdentifier(PEGTransformer &transformer, std::string_view identifier);
