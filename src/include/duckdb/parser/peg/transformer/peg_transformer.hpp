...
private:
	...
	static unique_ptr<AlterTableInfo> TransformDropConstraint(PEGTransformer &transformer, const bool &if_exists, std::string_view identifier, const bool &drop_behavior);
	...
	static unique_ptr<AlterTableInfo> TransformRenameConstraint(PEGTransformer &transformer, std::string_view identifier, std::string_view identifier_1);
	...
	static unique_ptr<AlterTableInfo> TransformRenameColumn(PEGTransformer &transformer, unique_ptr<ColumnRefExpression> nested_column_name, std::string_view identifier);
	...
	static unique_ptr<ColumnRefExpression> TransformNestedColumnName(PEGTransformer &transformer, const vector<Identifier> &identifier_dot, std::string_view column_name);
	...
	static Identifier TransformIdentifierDot(PEGTransformer &transformer, std::string_view identifier);
	static unique_ptr<TransformResultValue> TransformRenameAlterInternal(PEGTransformer &transformer, ParseResult &parse_result);
	static unique_ptr<AlterTableInfo> TransformRenameAlter(PEGTransformer &transformer, std::string_view identifier);
	...
	static QualifiedName TransformQualifiedSequenceName(PEGTransformer &transformer, const Identifier &catalog_qualification, const Identifier &schema_qualification, std::string_view sequence_name);
	...
	static unique_ptr<AlterInfo> TransformAlterDatabaseStmt(PEGTransformer &transformer, const bool &if_exists, std::string_view identifier, std::string_view identifier_1);
	...
	static unique_ptr<SQLStatement> TransformCheckpointStatement(PEGTransformer &transformer, const bool &checkpoint_force, std::string_view catalog_name);
	...
	static unique_ptr<SQLStatement> TransformConnectStatement(PEGTransformer &transformer, unique_ptr<ConnectInfo> session_target);
	...
	static unique_ptr<ConnectInfo> TransformCatalogSessionTarget(PEGTransformer &transformer, std::string_view catalog_name);
	...
	static unique_ptr<SQLStatement> TransformCreateDatabaseStatement(PEGTransformer &transformer, const bool &if_not_exists, std::string_view catalog_name);
	...
	static unique_ptr<SQLStatement> TransformDropDatabaseStatement(PEGTransformer &transformer, const bool &if_exists, std::string_view catalog_name, const bool &drop_database_force);
	...
	static Identifier TransformSecretStorageSpecifier(PEGTransformer &transformer, std::string_view identifier);
	...
	static Identifier TransformTriggerName(PEGTransformer &transformer, std::string_view identifier);
	...
	static unique_ptr<SQLStatement> TransformDetachStatement(PEGTransformer &transformer, const bool &if_exists, std::string_view catalog_name);
	...
	static unique_ptr<SQLStatement> TransformExecuteStatement(PEGTransformer &transformer, std::string_view identifier, vector<FunctionArgument> table_function_arguments);
	...
	static string TransformExportSource(PEGTransformer &transformer, std::string_view catalog_name);
	...
	static Identifier TransformExtensionAlias(PEGTransformer &transformer, std::string_view identifier);
	...
	static ExtensionRepositoryInfo TransformFromSourceIdentifier(PEGTransformer &transformer, std::string_view identifier);
	...
	static unique_ptr<SQLStatement> TransformPragmaAssign(PEGTransformer &transformer, std::string_view setting_name, vector<unique_ptr<ParsedExpression>> variable_list);
	...
	static unique_ptr<SQLStatement> TransformPragmaFunction(PEGTransformer &transformer, std::string_view pragma_name, vector<unique_ptr<ParsedExpression>> pragma_parameters);
	...
	static unique_ptr<SQLStatement> TransformPrepareStatement(PEGTransformer &transformer, std::string_view identifier, const vector<LogicalType> &type_list, unique_ptr<SQLStatement> statement);
	...
	static string TransformUpdateSetColumnTarget(PEGTransformer &transformer, std::string_view column_name, const vector<Identifier> &dot_identifier);
	...
	static QualifiedName TransformSchemaNameAsUseTarget(PEGTransformer &transformer, std::string_view schema_name);
	...
	static QualifiedName TransformCatalogNameAsUseTarget(PEGTransformer &transformer, std::string_view catalog_name);
	...
	static QualifiedName TransformUseTargetCatalogSchema(PEGTransformer &transformer, std::string_view catalog_name, std::string_view reserved_schema_name, const vector<Identifier> &dot_identifier);
	...
	static Identifier TransformDotIdentifier(PEGTransformer &transformer, std::string_view identifier);
