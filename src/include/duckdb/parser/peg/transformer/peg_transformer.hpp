...
private:
	...
	static unique_ptr<ParsedExpression> TransformSetValue(PEGTransformer &transformer, ParseResult &parse_result);
	...
	TransformAttachStatement(PEGTransformer &transformer, const optional<bool> &or_replace,
	                         ...
	                         unique_ptr<ParsedExpression> database_path, const optional<string> &attach_alias,
	...
	static unique_ptr<TransformResultValue> TransformAttachAliasInternal(PEGTransformer &transformer,
	                                                                     ParseResult &parse_result);
	static string TransformAttachAlias(PEGTransformer &transformer, const Identifier &col_id);
	...
	static unique_ptr<TransformResultValue> TransformConstraintNameInternal(PEGTransformer &transformer,
	                                                                        ParseResult &parse_result);
	static string TransformConstraintName(PEGTransformer &transformer, const Identifier &col_id_or_string);
	...
	static unique_ptr<TransformResultValue> TransformFromOrToInternal(PEGTransformer &transformer,
	                                                                  ParseResult &parse_result);
	static bool TransformFromOrTo(PEGTransformer &transformer);
	...
	TransformCreateIndexStmt(PEGTransformer &transformer, const bool &has_result, const optional<bool> &if_not_exists,
	                         ...
	                         optional<vector<unique_ptr<ParsedExpression>>> index_element, const bool &has_result_1,
	...
	static unique_ptr<TransformResultValue> TransformMacroOrFunctionInternal(PEGTransformer &transformer,
	                                                                         ParseResult &parse_result);
	static bool TransformMacroOrFunction(PEGTransformer &transformer);
	...
	static unique_ptr<TransformResultValue> TransformCreatePublicationStatementInternal(PEGTransformer &transformer,
	                                                                                    ParseResult &parse_result);
	static unique_ptr<SQLStatement> TransformCreatePublicationStatement(PEGTransformer &transformer,
	                                                                    const Identifier &identifier,
	...
	static unique_ptr<TransformResultValue> TransformCreateSubscriptionStatementInternal(PEGTransformer &transformer,
	                                                                                     ParseResult &parse_result);
	static unique_ptr<SQLStatement> TransformCreateSubscriptionStatement(PEGTransformer &transformer,
	                                                                     const Identifier &identifier,
	                                                                     const bool &has_result);
	...
	TransformColumnDefinition(PEGTransformer &transformer, const vector<string> &dotted_identifier,
	                          ...
	                          const optional<string> &constraint_name_clause,
	                          optional<vector<ColumnConstraintEntry>> column_constraint);
	...
	static unique_ptr<TransformResultValue> TransformDropTSDictionaryStatementInternal(PEGTransformer &transformer,
	                                                                                   ParseResult &parse_result);
	static unique_ptr<SQLStatement> TransformDropTSDictionaryStatement(PEGTransformer &transformer,
	                                                                   const optional<bool> &if_exists,
	                                                                   const QualifiedName &qualified_name);
	...
	static unique_ptr<TransformResultValue> TransformCreateTypeInternal(PEGTransformer &transformer,
	                                                                    ParseResult &parse_result);
	static unique_ptr<CreateTypeInfo> TransformCreateType(PEGTransformer &transformer, ParseResult &choice_result);
	...
	static unique_ptr<QueryNode> TransformShowTables(PEGTransformer &transformer, const ShowType &show_or_describe,
	                                                 const QualifiedName &qualified_name);
	static unique_ptr<TransformResultValue> TransformShowAliasedSettingInternal(PEGTransformer &transformer,
	                                                                            ParseResult &parse_result);
	static unique_ptr<QueryNode> TransformShowAliasedSetting(PEGTransformer &transformer,
	                                                         const ShowType &show_or_describe);
	...
	static unique_ptr<TransformResultValue> TransformDescribeRuleInternal(PEGTransformer &transformer,
	                                                                      ParseResult &parse_result);
	static ShowType TransformDescribeRule(PEGTransformer &transformer);
	...
	static unique_ptr<TransformResultValue> TransformBitOperatorInternal(PEGTransformer &transformer,
	                                                                     ParseResult &parse_result);
	static string TransformBitOperator(PEGTransformer &transformer);
	...
	static unique_ptr<TransformResultValue> TransformTermInternal(PEGTransformer &transformer,
	                                                              ParseResult &parse_result);
	static string TransformTerm(PEGTransformer &transformer);
	...
	static unique_ptr<TransformResultValue> TransformFactorInternal(PEGTransformer &transformer,
	                                                                ParseResult &parse_result);
	static string TransformFactor(PEGTransformer &transformer);
	...
	static unique_ptr<TransformResultValue> TransformExponentOperatorInternal(PEGTransformer &transformer,
	                                                                          ParseResult &parse_result);
	static string TransformExponentOperator(PEGTransformer &transformer);
	...
	static unique_ptr<TransformResultValue> TransformSelectIntoClauseInternal(PEGTransformer &transformer,
	                                                                          ParseResult &parse_result);
	static unique_ptr<BaseTableRef> TransformSelectIntoClause(PEGTransformer &transformer,
	                                                          unique_ptr<BaseTableRef> base_table_name);
	...
	static unique_ptr<SQLStatement> TransformSetStatement(PEGTransformer &transformer,
	                                                      unique_ptr<SetStatement> set_session_characteristics);
	...
	static unique_ptr<TransformResultValue> TransformResetAllInternal(PEGTransformer &transformer,
	                                                                  ParseResult &parse_result);
	static SettingInfo TransformResetAll(PEGTransformer &transformer);
	static unique_ptr<TransformResultValue> TransformResetAliasedSettingInternal(PEGTransformer &transformer,
	                                                                             ParseResult &parse_result);
	static SettingInfo TransformResetAliasedSetting(PEGTransformer &transformer);
	...
	static unique_ptr<TransformResultValue> TransformIsolationLevelInternal(PEGTransformer &transformer,
	                                                                        ParseResult &parse_result);
	static TransactionIsolationLevel TransformIsolationLevel(PEGTransformer &transformer);
