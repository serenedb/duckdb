...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"SubscriptionAlterAction <- SubscriptionEnableAction / SubscriptionConnectionAction / SubscriptionPublicationAction / SubscriptionRenameAction / SubscriptionOwnerAction / SubscriptionSetOptions\n"
	"SubscriptionEnableAction <- 'ENABLE' / 'DISABLE'\n"
	"SubscriptionConnectionAction <- 'CONNECTION' StringLiteral\n"
	"SubscriptionPublicationAction <- SubscriptionPublicationMode 'PUBLICATION' List(Identifier)\n"
	"SubscriptionPublicationMode <- 'SET' / 'ADD' / 'DROP'\n"
	"SubscriptionRenameAction <- 'RENAME' 'TO' Identifier\n"
	"SubscriptionOwnerAction <- 'OWNER' 'TO' Identifier\n"
