...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"SetStatement <- 'SET' (SetSessionCharacteristics / SetTransactionIsolation / StandardAssignment / SetTimeZone)\n"
	...
	"BeginTransaction <- StartOrBegin Transaction? IsolationLevelClause? ReadOrWrite?\n"
	...
	"DescribeStatement <- ShowTables / ShowSelect / ShowAllTables / ShowAllSettings / ShowQualifiedName\n"
