...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"DescribeStatement <- DescribePropertyGraph / ShowTables / ShowSelect / ShowAllTables / ShowAliasedSetting / ShowAllSettings / ShowQualifiedName\n"
	...
	"InsertStatement <- WithClause? 'INSERT' OrAction? 'INTO' InsertTarget ByNameOrPosition? InsertColumnList? OverridingClause? InsertValues OnConflictClause? ReturningClause?\n"
	...
	"OverridingClause <- 'OVERRIDING' OverridingKind 'VALUE'\n"
	"OverridingKind <- OverridingSystem / OverridingUser\n"
	...
	"ReindexStatement <- 'REINDEX' ReindexKind ReindexConcurrently? BaseTableName\n"
	"ReindexKind <- 'INDEX'\n"
	"ReindexConcurrently <- 'CONCURRENTLY'\n"
