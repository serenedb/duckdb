...
const char INLINED_PEG_GRAMMAR[] = {
	...
	"CreateSchemaStmt <- 'SCHEMA' IfNotExists? QualifiedName? SchemaAuthorization?\n"
	"SchemaAuthorization <- 'AUTHORIZATION' ColId\n"
	...
	"ColumnCompression <- 'USING' 'COMPRESSION' ColIdOrString Parens(List(Expression))?\n"
	...
	"CreateTSDictionaryStatement <- 'CREATE' 'TEXT' 'SEARCH' 'DICTIONARY' IfNotExists? QualifiedName TSDictionaryExpression\n"
	"DropTSDictionaryStatement <- 'DROP' 'TEXT' 'SEARCH' 'DICTIONARY' IfExists? QualifiedName\n"
	"TSDictionaryExpression <- 'AS' Expression TSDictionaryWith?\n"
	"TSDictionaryWith <- 'WITH' TSDictionaryDefinition\n"
	...
	"NamedParameter <- NamedParameterName Type? NamedParameterAssignment Expression\n"
	"NamedParameterName <- ReservedKeyword / UnreservedKeyword / ColumnNameKeyword / FuncNameKeyword / TypeNameKeyword / Identifier\n"
