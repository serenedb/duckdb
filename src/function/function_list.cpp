...
static const StaticFunctionDefinition function[] = {
	...
	DUCKDB_SCALAR_FUNCTION_SET(InternalDateTruncBucketFun),
	DUCKDB_SCALAR_FUNCTION_SET(InternalDateTruncMonthBucketFun),
	DUCKDB_SCALAR_FUNCTION(InternalDateTruncMonthUnbucketFun),
	DUCKDB_SCALAR_FUNCTION(InternalDateTruncMonthUnbucketTzFun),
	DUCKDB_SCALAR_FUNCTION(InternalDateTruncUnbucketFun),
	DUCKDB_SCALAR_FUNCTION(InternalDateTruncUnbucketTimeFun),
	DUCKDB_SCALAR_FUNCTION(InternalDateTruncUnbucketTzFun),
	DUCKDB_SCALAR_FUNCTION(InternalDayNameFun),
	DUCKDB_SCALAR_FUNCTION_SET(InternalDayOfWeekFun),
	...
	DUCKDB_SCALAR_FUNCTION(InternalMonthNameFun),
	DUCKDB_SCALAR_FUNCTION_SET(InternalMonthOfYearFun),
	DUCKDB_SCALAR_FUNCTION_SET(InternalTimeOfDayBucketFun),
	...
	DUCKDB_SCALAR_FUNCTION_SET(SimilarToEscapeFun),
